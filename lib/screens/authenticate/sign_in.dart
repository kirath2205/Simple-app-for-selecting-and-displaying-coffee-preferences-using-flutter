    ...
    return loading? Loading():Scaffold
      (
        ...
        appBar: AppBar
          ...
          title:Text('Sign in to Spike exercise'),
          actions: <Widget>[FlatButton.icon(icon:Icon(Icons.person),label:Text('Register'),onPressed: (){widget.toggle_view();},)],
